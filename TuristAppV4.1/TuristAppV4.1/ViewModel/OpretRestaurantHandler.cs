...
namespace TuristAppV4._1.ViewModel
{
    class OpretRestaurantHandler
    {
        ...
        {
            _reference.ObservableCollectionOfRestaurants1.Add(new Restaurant(_restaurantNavn, _bedømmelse, _hjemmeside, _beskrivelse, _telefon, _billede));
        }

        public void OpretRestaurantKategori2(ObservableCollection<Restaurant> observableCollection)
        {
            _reference.ObservableCollectionOfRestaurants2.Add(new Restaurant(_restaurantNavn, _bedømmelse, _hjemmeside, _beskrivelse, _telefon, _billede));
        }

        public void OpretRestaurantKategori3(ObservableCollection<Restaurant> observableCollection)
        {
            _reference.ObservableCollectionOfRestaurants3.Add(new Restaurant(_restaurantNavn, _bedømmelse, _hjemmeside, _beskrivelse, _telefon, _billede));
        }
    }
}
